...
#define OPH_SERVER_CONF_PMEM              "PMEM"
#define OPH_SERVER_CONF_PMEM_MAX_SIZE     "PMEM_MAX_SIZE"
...
static const char *const oph_server_conf_params[] =
	...
	OPH_SERVER_CONF_CACHE_LINE_SIZE, OPH_SERVER_CONF_CACHE_SIZE, OPH_SERVER_CONF_WORKING_DIR, OPH_SERVER_CONF_PMEM, OPH_SERVER_CONF_PMEM_MAX_SIZE, NULL
};
