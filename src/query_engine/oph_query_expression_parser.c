...
#define yylval          eelval
#define yychar          eechar
#define yydebug         eedebug
#define yynerrs         eenerrs

/* Copy the first part of user declarations.  */
/* Line 371 of yacc.c  */
#line 1 "oph_query_expression_parser.y"
...
/* Line 387 of yacc.c  */
#line 174 "oph_query_expression_parser.c"
} YYSTYPE;
...
/* Line 390 of yacc.c  */
#line 201 "oph_query_expression_parser.c"
...
{
      22,     0,    -1,    23,    -1,     1,    -1,    23,     6,    23,
      -1,    23,     7,    23,    -1,    23,     5,    23,    -1,    23,
       8,    23,    -1,    23,    11,    23,    -1,    23,     9,    23,
      -1,    23,     3,    23,    -1,    23,     4,    23,    -1,    12,
      23,    -1,     5,    23,    -1,    18,    23,    19,    -1,    15,
      -1,    16,    -1,    17,    -1,    13,    -1,    13,    18,    24,
      19,    -1,    14,    -1,    23,    -1,    24,    20,    23,    -1
};
...
static const char *const yytname[] =
{
  ...
  "VNULL", "'('", "')'", "','", "$accept", "input", "expr", "arg_list", YY_NULL
};
#endif
...
#else
static void
yy_symbol_print (yyoutput, yytype, yyvaluep, mode, expression, scanner)
    FILE *yyoutput;
    int yytype;
    YYSTYPE const * const yyvaluep;
    int mode;
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, int yyrule, int mode, oph_query_expr_node **expression, yyscan_t scanner)
#else
static void
yy_reduce_print (yyvsp, yyrule, mode, expression, scanner)
    YYSTYPE *yyvsp;
    int yyrule;
    int mode;
    oph_query_expr_node **expression;
...
do {					\
  if (yydebug)				\
    yy_reduce_print (yyvsp, Rule, mode, expression, scanner); \
} while (YYID (0))
...
#else
static void
yydestruct (yymsg, yytype, yyvaluep, mode, expression, scanner)
    const char *yymsg;
    int yytype;
    YYSTYPE *yyvaluep;
    int mode;
...
#else
int
yyparse (mode, expression, scanner)
    int mode;
    oph_query_expr_node **expression;
    yyscan_t scanner;
#endif
...
#line 75 "oph_query_expression_parser.y"
  ...
  case 16:
/* Line 1792 of yacc.c  */
#line 76 "oph_query_expression_parser.y"
...
#line 80 "oph_query_expression_parser.y"
  ...
  case 20:
/* Line 1792 of yacc.c  */
#line 82 "oph_query_expression_parser.y"
...
/* Line 2055 of yacc.c  */
#line 90 "oph_query_expression_parser.y"
