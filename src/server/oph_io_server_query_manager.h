 ...
 * \param sub_operation String representing a low level operation to be executed on data load
 * \param sub_args Parameters of a low level operation to be executed on data load
